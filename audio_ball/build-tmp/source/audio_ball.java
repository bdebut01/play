...
class ball {
  ...
  public void check() {
    ...
    //check boundries
    if (pos.x < 10.0f) _bounceX(20 - pos.x); //left
  ...
  public void _bounceX(float newX) {
    pos.x = newX;
    spd.x *= -0.7f;
    _bounce(spd.x);
  }
   
  public void _bounceY(float newY) {
    pos.y = newY;
    spd.y *= -0.7f;
    _bounce(spd.y);
  }
   
  public void _bounce(float speed) {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "audio_ball" };
    if (passedArgs != null) {
